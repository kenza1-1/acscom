 ...
 */
final class Version20200307223904 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE produits DROP image_id, DROP quantite');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE produits ADD image_id INT DEFAULT NULL, ADD quantite INT NOT NULL');
